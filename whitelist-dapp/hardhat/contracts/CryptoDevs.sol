...
contract CryptoDevs is ERC721Enumerable, Ownable {
    ...
    function  mint() public payable {
        ...
        require(totalSupply() + reservedTokens - reservedTokensClaimed < maxTokenIds, "EXCEED_MAX_SUPPLY");
        ...
        if(whitelist.whitelistedAddresses(msg.sender) && msg.value < _price) {
            ...
            //If user is not part of the whitelist, make sure they have sent enought ETH
